INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (1, 'John', 'Doe', 'johndoe@example.com', 'johndoe', 'password123', 0, 1, 'profile_picture1.jpg');
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (2, 'Alice', 'Smith', 'alicesmith@example.com', 'alicesmith', 'securepass', 1, 0, null);
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (3, 'Maria', 'Sanchez', 'mariasanchez@example.com', 'mariasanchez', 'maria123', 0, 0, null);
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (4, 'Georgi', 'Stoyanov', 'georgistoyanov@example.com', 'georgist', 'georgi1234', 0, 0, 'profile_picture2.jpg');
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (5, 'Berta', 'Morar', 'berta.morar@example.com', 'bertamorar', 'berta123456', 0, 1, null);
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (6, 'Serena', 'Hayes', 'serena.hayes@example.com', 'serenaHayes1', 'serena09876', 1, 0, 'profile_picture3.jpg');
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (7, 'Zella', 'Kertzman', 'zella.kertzman@example.com', 'zella.kertzman', '1234zella', 0, 1, null);
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (11, 'fefwefwefe3wvr3', 'ddddddddddd', 'ddddddddddddd@abv.bg', 'ddddddddddd', 'ddddddddddd', 0, 0, null);
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (12, 'ddddddddddd', 'ddddddddddd', 'ddddddddddddd@abv.bg', 'ddddddddddddddd', 'ddddddddddd', 0, 0, null);
