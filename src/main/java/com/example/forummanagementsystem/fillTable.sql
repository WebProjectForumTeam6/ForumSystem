...
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (2, 'Alice', 'Smith', 'alicesmith@example.com', 'alicesmith', 'securepass', 1, 0, 'https://static.vecteezy.com/system/resources/previews/020/765/399/non_2x/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg');
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (3, 'Maria', 'Sanchez', 'mariasanchez@example.com', 'mariasanchez', 'maria123', 0, 0, 'https://static.vecteezy.com/system/resources/previews/020/765/399/non_2x/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg');
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (4, 'Georgi', 'Stoyanov', 'georgistoyanov@example.com', 'georgist', 'georgi1234', 0, 0, 'https://static.vecteezy.com/system/resources/previews/020/765/399/non_2x/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg');
...
INSERT INTO forum.users (user_id, first_name, last_name, email, username, password, is_blocked, is_admin, profile_picture_url) VALUES (7, 'Zella', 'Kertzman', 'zella.kertzman@example.com', 'zella.kertzman', '1234zella', 0, 1, 'https://static.vecteezy.com/system/resources/previews/020/765/399/non_2x/default-profile-account-unknown-icon-black-silhouette-free-vector.jpg');
